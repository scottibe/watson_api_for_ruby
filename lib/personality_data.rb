 require 'json'
 require 'pry'
 require_relative 'personality_analyzer'
...
class BigFiveScores
  ...
  def self.name_results
    hash = Hash[self.names.zip self.percentile_scores]   
  end  

  def self.create_from_hash
    score_hash = self.name_results
    new_object = BigFiveScores.new(score_hash)
  end
  ...
  #   "People wwwww....aAAA>      who score high tend to have the following qualities."
  #   "-They find helping others generally rewarding."
  #   "-They dislike confrontation."
  #   "-The see no need for pretense or manipulation when dealing with others."
  # end 
